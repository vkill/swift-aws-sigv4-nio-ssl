...
sed -i '' 's/^public func/func/; s/^import Foundation/import struct Foundation.Data/' Sources/AwsSigv4CNIOSSL/Hash.swift
...
sed -i '' '/^import Foundation/d' Sources/AwsSigv4CNIOSSL/HMAC.swift
